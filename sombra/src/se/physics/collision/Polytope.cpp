...
namespace se::physics {
	...
	{
		int iVertex = se::physics::addVertex(mMesh, sp.getCSOPosition());
	...
	{
		int iFace = se::physics::addFace(mMesh, faceIndices.begin(), faceIndices.end());
	...
	{
		se::physics::removeFace(mMesh, iFace);
