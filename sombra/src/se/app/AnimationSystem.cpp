...
namespace se::app {
	...
	void AnimationSystem::onNewComponent(
	...
	void AnimationSystem::onRemoveComponent(
		Entity entity, const EntityDatabase::ComponentMask& mask,
		EntityDatabase::Query& query
	) {
		tryCallC(&AnimationSystem::onRemoveAComponent, entity, mask, query);
	}
	...
	void AnimationSystem::update()
	{
		...
		mEntityDatabase.executeQuery([this](EntityDatabase::Query& query) {
			...
			query.iterateEntityComponents<TransformsComponent, SkinComponent>(
...
// Private functions
	void AnimationSystem::onNewAComponent(Entity entity, AnimationComponent* animationComponent, EntityDatabase::Query& query)
	{
