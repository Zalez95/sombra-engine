...
option(INSTALLED_MINIAUDIO	"Use installed Miniaudio library"		ON)
...
find_package(Miniaudio "0.11.8" QUIET)
if(MINIAUDIO_FOUND AND INSTALLED_MINIAUDIO)
	message("MINIAUDIO FOUND: Using system library")
else()
	message("MINIAUDIO NOT FOUND: Downloading and building MINIAUDIO from source")
	include(ExternalMiniaudio)
endif()
