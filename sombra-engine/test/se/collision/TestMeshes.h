...
std::pair<se::collision::HalfEdgeMesh, se::collision::ContiguousVector<glm::vec3>> createTestMesh2();
...
se::collision::HalfEdgeMesh createTestMesh5();
std::vector<se::collision::HalfEdgeMesh> createTestMesh6();
...
std::vector<se::collision::HalfEdgeMesh> createTestTube2();
