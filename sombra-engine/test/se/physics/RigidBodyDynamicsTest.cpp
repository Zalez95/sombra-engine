...
TEST(RigidBody, linearVelocityIntegration)
{
	...
	RigidBody rb(3.5f, 1.0f, glm::mat3(2.0f / 5.0f * 3.5f * std::pow(2.0f, 2)), 1.0f);
...
TEST(RigidBody, forceIntegration)
{
	...
	RigidBody rb(4.512f, 1.0f, glm::mat3(2.0f / 5.0f * 4.512f * std::pow(2.0f, 2)), 1.0f);
...
TEST(RigidBody, torqueIntegration)
{
	...
	RigidBody rb(3.953f, 1.0f, glm::mat3(2.0f / 5.0f * 3.953f * std::pow(2.0f, 2)), 1.0f);
...
TEST(RigidBody, transformsIntegration)
{
	...
	RigidBody rb(6.1781f, 1.0f, glm::mat3(6.1781f * std::pow(3.21f, 2) / 6.0f), 1.0f);
