...
TEST(CoarseCollisionDetector, collide)
{
	...
	cp1.setTransforms(glm::translate(glm::mat4(), glm::vec3(2.0f, 4.0f, 4.0f)));
	ccd.submit(&cp1);
	...
	cp2.setTransforms(glm::translate(glm::mat4(), glm::vec3(0.0f, 4.0f, 4.0f)));
	ccd.submit(&cp2);

	fe::collision::BoundingSphere bs1(1.0f);
	bs1.setTransforms(glm::translate(glm::mat4(), glm::vec3(4.0f, 7.0f, 5.0f)));
	ccd.submit(&bs1);

	fe::collision::BoundingSphere bs2(1.0f);
	bs2.setTransforms(glm::translate(glm::mat4(), glm::vec3(4.0f, 3.0f, 5.0f)));
	ccd.submit(&bs2);
